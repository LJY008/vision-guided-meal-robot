...
class TrackerData:
    def __init__(self, window_size=300, num_frames=5, detection_interval=1, swallow_timeout=0.8, displacement_threshold=5):
        self.tracker_positions = {}
        self.timestamps = []
        self.window_size = window_size  # 设置时间窗口大小（秒）hhh
